...
public class AdminController {
    ...
    public String addStudent(StudentCustom studentCustom, Model model) throws Exception {
        ...
        userlogin.setAccount(studentCustom.getUid().toString());
    ...
    public String editStudent(StudentCustom studentCustom) throws Exception {
        ...
        studentService.updataById(studentCustom.getUid(), studentCustom);
    ...
    public String addTeacher(TeacherCustom teacherCustom, Model model) throws Exception {
        ...
        //添加成功后，也添加到登录表
        User userlogin = new User();
        userlogin.setAccount(teacherCustom.getUid().toString());
        userlogin.setPassword("123");
        userlogin.setRole(1);
        userloginService.save(userlogin);
    ...
    public String editTeacher(TeacherCustom teacherCustom) throws Exception {
        ...
        teacherService.updateById(teacherCustom.getUid(), teacherCustom);
    ...
    public String showCourse(Model model, Integer page) throws Exception {
        ...
        if (page == null || page == 0) {
            pagingVO.setToPageNo(1);
            //todo
            list = courseService.findCourseById(1);
        } else {
            pagingVO.setToPageNo(page);
            //todo
            list = courseService.findCourseById(1);
    ...
    public String addCourse(CourseDTO courseCustom, Model model) throws Exception {
    ...
    public String editCourse(CourseDTO courseCustom) throws Exception {
    ...
    private String selectCourse(String findByName, Model model) throws Exception {
        ...
        List<CourseDTO> list = courseService.findByName(findByName);
    ...
    public String userPasswordRest(User userlogin) throws Exception {

        User u = userloginService.findByAccount(userlogin.getAccount());
        ...
        if (u != null) {
            ...
            userloginService.updateByName(userlogin.getAccount(), u);
        } else {
